  ...
  const stageConfigs = useMemo<StageConfig[]>(
    () => [
      ...
      },
      {
        key: "inspections",
        title: "Inspections",
        description: "Site inspections handed off to field teams.",
        icon: ClipboardCheck,
        totalCount: sortedInspectionPending.length,
        pills: [
          {
      ...
      },
      {
        key: "inflow",
        title: "New Queue (DA)",
        description: "Owner submissions waiting at the DA stage.",
        icon: FileText,
        pills: [
          {
            value: "inflow-new",
            ...
            description: "Fresh homestay registrations waiting for DA scrutiny.",
            applications: sortedDaNewRegistrations,
            actionLabel: "Open application",
            emptyTitle: "No new registrations",
            emptyDescription: "No brand-new homestays were routed recently.",
          },
          {
            value: "inflow-service",
            label: "Current License Holders",
            count: sortedDaServiceRequests.length,
            description: "Service requests from licensed owners awaiting DA review.",
            applications: sortedDaServiceRequests,
            actionLabel: "Review request",
            emptyTitle: "No service requests",
            emptyDescription: "No licensed owners are awaiting DTDO action.",
          },
        ],
      },
    ],
